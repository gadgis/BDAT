...
datacov_shrt <- st_drop_geometry(datacov_shrt)
...
terra::writeRaster(r,file=paste0("Y:/BDAT/traitement_donnees/MameGadiaga/resultats/",name,"qrf_centroides.tif"),overwrite=TRUE)
